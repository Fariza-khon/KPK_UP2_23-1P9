...
## 2. Создание аудитории (create)

### Parameters for creation

| Parameter | Description | Required | Type | Constraint | Default |
|-----------|-------------|-----------|------|------------|---------|
| room_number | Номер аудитории | Yes | str | - | - |
...
| is_active | Статус активности | boolean |
| types | Связанные типы аудитории (агрегированный результат из ROOM_ROOM_TYPE) | array of RoomTypeResponse |

---

## 3. Изменение аудитории по ID (change)
...
## 4. Удаление аудитории по ID (delete)
...
* **True** — аудитория успешно помечена как удалённая
* **False** — запись не найдена или произошла ошибка

---

## 5. Получение аудитории по ID (get)
...
| capacity | Вместимость | int |
| is_active | Статус активности | boolean |
| types | Связанные типы аудитории | array of RoomTypeResponse |

---

## 6. Получение списка аудиторий (get list)

### Search parameters

| Parameter | Description | Required | Type | Constraint | Default |
|-----------|-------------|-----------|------|------------|---------|
| room_number | Номер аудитории | No | str | - | - |
| building | Корпус | No | str | - | - |
| limit | Лимит записей | No | int | ≤ 100 | 10 |
